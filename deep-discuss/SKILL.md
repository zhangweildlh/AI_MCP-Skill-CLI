---
name: deep-discuss
description: "结构化深度讨论技能 v2.0：基于模块化架构，集成外部增强模块（5Why、Premortem、Consult）以加强问题审查、深度分析和方案自检。保持原有7阶段流程框架，通过懒加载和接口契约实现依赖解耦，确保随上游更新保持稳定。适用场景：用户描述问题现象/故障表现/技术困惑/方案选择困难，或明确说'讨论一下'/'帮我分析'/'我遇到一个问题'/'你觉得怎么样'/'帮我想想'/'我在纠结'时触发。不适用场景：纯事实查询、简单配置指导、代码片段生成、单轮问答无需深度思考。"
version: 2.0.0
---
